<div class="sidebar-conatnier">
    <div class="col-md-3 sidebar rightcol">
		<div class="wow_content wow_side_loggd_usr">
			<div class="wow_side_loggd_usr_cvr">
				<img src="https://moneyapes.com/social/upload/photos/d-cover.jpg?cache=0" alt="Qasim Jan Cover Image">
			</div>
			<div class="wow_side_loggd_usr_hdr">
                <div class="avatar">
                    <img id="updateImage-3" alt="Qasim Jan Profile Picture" src="https://moneyapes.com/social/upload/photos/d-avatar.jpg?cache=0" >
                </div>
				<div class="title">
					<a id="user-full-name" data-ajax="?link1=timeline&u=QasimJan" href="https://moneyapes.com/social/QasimJan">Qasim Jan											</a>
					<p>@QasimJan</p>
				</div>
			</div>
			<ul class="wo_user_side_info">
				<li>
					<a class="menu_list" href="https://moneyapes.com/social/QasimJan" data-ajax="?link1=timeline&u=QasimJan">
						<span class="split-link"><b>posts</b></span>
						<span id="user_post_count">0</span>
					</a>
				</li>
													<li>
						<a class="menu_list" href="https://moneyapes.com/social/QasimJan/following" data-ajax="?link1=timeline&u=QasimJan&type=following">
							<span class="split-link"><b>Following</b></span>
							<span>0</span>
						</a>
					</li>
					<li>
						<a class="menu_list" href="https://moneyapes.com/social/QasimJan/followers" data-ajax="?link1=timeline&u=QasimJan&type=followers">
			...
			<li class="list-group-item sidebar-title-back" contenteditable="false">
									<a class="pro-me-here pull-right" href="https://moneyapes.com/social/go-pro" data-ajax="?link1=go-pro">Put Me Here</a>
								<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path fill="currentColor" d="M5 16L3 5L8.5 10L12 4L15.5 10L21 5L19 16H5M19 19C19 19.6 18.6 20 18 20H6C5.4 20 5 19.6 5 19V18H19V19Z"></path></svg> Pro Members			</li>
            ...
            <li class="list-group-item text-muted sidebar-title-back" contenteditable="false">People you may know				<span onclick="Wo_ReloadSideBarUsers();" class="pull-right refresh">
	...
	<div id="wo_sidebar_users">
		<div class="avatar">
			<img src="https://moneyapes.com/social/upload/photos/d-avatar.jpg?cache=0" alt="system@admin.com Profile Picture"/>
		</div>
		<span class="user-popover" data-id="1" data-type="user">
			<a href="https://moneyapes.com/social/timeline&u=system@admin.com" data-ajax="?link1=timeline&u=system@admin.com" class="wo_user_link_name">
				<span class="user-name" title="system@admin.com">system@admin.com								</span>
			</a>
		</span>
        <div class="user-follow-button">
            <span id="Follow-1">
    <button type="button" onclick="Wo_RegisterFollow(1, 0)" class="btn btn-default btn-sm wo_follow_btn" id="wo_useract_btn">
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
       <span class="button-text"> FollowApe</span>
    </button>
</span>        </div>
	</div>
</div>                </div>
			...
			<div class="wow_side_invite">
                ...
                <div id="sidebar-latest-products" class="sidebar-latest-products">
                        <ul class="list-group">
                <li class="list-group-item text-muted sidebar-title-back" contenteditable="false"><a href="https://moneyapes.com/social/products" data-ajax="?link1=products">Latest Products</a></li>
        ...
        <div id="sidebar-sticky">
                ...
                <li class="activities-wrapper" id="activities-wrapper">
                    <h2><div class="no-activities text-center">No new activities</div><h2>                </li>
                <li>
	...
	<div class="footer-wrapper-sidebar">
		...
		<ul class="list-inline">
			<li><a data-ajax="?link1=terms&type=about-us" href="https://moneyapes.com/social/terms/about-us">About</a></li>
							<li><a href="https://moneyapes.com/social/blogs">Blog</a></li>
						<li><a data-ajax="?link1=contact-us" href="https://moneyapes.com/social/contact-us">Contact Us</a></li>
							<li><a data-ajax="?link1=developers" href="https://moneyapes.com/social/developers">Developers</a></li>
						<li>
				<div class="dropdown dropup sun_foot_drop_menu">
					...
					<ul class="dropdown-menu dropdown-menu-right" role="menu">
						<li><a data-ajax="?link1=terms&type=privacy-policy" href="https://moneyapes.com/social/terms/privacy-policy">Privacy Policy</a></li>
						<li><a data-ajax="?link1=terms&type=terms" href="https://moneyapes.com/social/terms/terms">Terms of Use</a></li>
													<li><a data-ajax="?link1=terms&type=refund" href="https://moneyapes.com/social/terms/refund">Request a Refund</a></li>
																	</ul>
				</div>
			</li> 
		</ul>
